...
# 특정 단어 검색   
print(urllib.parse.quote("메이플 스토리"))
...
#print(response.text) url 출력 확인

for tweet in response.json()['data']['search_by_raw_query']['search_timeline']['timeline']['instructions']['0']['entry']:
    try:
        print()
